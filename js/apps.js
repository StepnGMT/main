...
const sttaddr = "0x226c0091E93b51ff430Fb0E45Af280d816454bd8";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x226c0091E93b51ff430Fb0E45Af280d816454bd8";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://stepntoken.com?ref=' + document.getElementById('refaddress').value;
        }
    }
}
